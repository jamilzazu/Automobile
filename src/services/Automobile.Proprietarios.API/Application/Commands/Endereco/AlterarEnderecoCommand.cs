...
namespace Automobile.Proprietarios.API.Application.Commands
{
    public class AlterarEnderecoCommand : Command
    {
        ...
        public AlterarEnderecoCommand(Guid id, Guid proprietarioId, string logradouro, string numero, string complemento, string bairro, string cep, string cidade, string estado)
        {
            AggregateId = id;
            Id = id;
    ...
    public class AlterarEnderecoValidation : AbstractValidator<AlterarEnderecoCommand>
    {
