...
namespace Automobile.Application.Test.Commands.Endereco
{
    ...
    {
        private readonly CadastrarEnderecoCommand _enderecoCommando = new(Guid.NewGuid(), "", "44", "", "Centro", 78005000, 5103403,51, DateTime.Now);
        ...
        {
            var command = new AtualizarEnderecoCommand(_enderecoCommando.Id, _enderecoCommando.ProprietarioId, "", "44", "", "Centro", 78005000, 5103403,51, DateTime.Now);
